...
<img src="images/286082/c2d620c012a82e825570df631a7fbc3a.jpg" style="zoom:20%;" />
...
<img src="images/286082/d9689a38cbe67c3008d8ba99663c2f09.jpg" style="zoom:20%;" />
...
<img src="images/286082/5ceb2ab6f61c064284c8f8811431bc3d.jpg" style="zoom:20%;" />
...
<img src="images/286082/eb72b9f58052d6a6023d3e1dac522157.jpg" style="zoom:20%;" />
...
<img src="images/286082/8753ce6985fd08bb9cf9a3813c8b2cd2.jpg" style="zoom:20%;" />
...
<img src="images/286082/30cd42yy86debc0eb6e7c5b069533ab0.jpg" style="zoom:20%;" />
...
<img src="images/286082/41f02b2afb08ec54249680e8cac30179.jpg" style="zoom:20%;" />
...
+------------------------------------------------------------------------------+
|                           CPU 拓扑结构示意图                                  |
|     2个CPU Socket，每个6个物理核，每个物理核2个逻辑核，共24个逻辑核              |
+------------------------------------------------------------------------------+
...
物理核0     物理核1     物理核2     物理核0     物理核1     物理核2
┌───┐      ┌───┐      ┌───┐      ┌───┐      ┌───┐      ┌───┐
│0  │      │1  │      │2  │      │6  │      │7  │      │8  │  ← 第一个逻辑核
│12 │      │13 │      │14 │      │18 │      │19 │      │20 │  ← 第二个逻辑核
└───┘      └───┘      └───┘      └───┘      └───┘      └───┘

物理核3     物理核4     物理核5     物理核3     物理核4     物理核5
┌───┐      ┌───┐      ┌───┐      ┌───┐      ┌───┐      ┌───┐
│3  │      │4  │      │5  │      │9  │      │10 │      │11 │  ← 第一个逻辑核
│15 │      │16 │      │17 │      │21 │      │22 │      │23 │  ← 第二个逻辑核
└───┘      └───┘      └───┘      └───┘      └───┘      └───┘
```
