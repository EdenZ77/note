...
![](images/69859/98ac9df2593a193d6a7f1767cd68eb5f.png)
...
![](images/69859/4d3f622f272c49132ecb9760310ce1a7.png)
...
![](images/69859/395666667d77e718da63261be478a96b.png)
...
**中断（Interrupt，in）**：指狭义上的中断（外中断）

- 是指由硬件设备发出的信号，通知CPU需要处理一些事件。
- 常见的中断包括定时器中断、设备中断（如磁盘I/O完成、中断请求等）。
- 当中断发生时，CPU会暂停当前正在执行的任务，转而执行与中断相关的处理程序。处理完中断后，CPU会恢复原来的任务。
...
![](images/69859/565d66d658ad23b2f4997551db153852.jpg)